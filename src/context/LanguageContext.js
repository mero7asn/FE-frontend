  ...
  const t = (key, ...args) => {
    const translations = {
      en: {
        ...
        admin: 'Admin', adminLogin: 'Admin Login', login: 'Sign In', register: 'Register', logout: 'Logout', account: 'Account',
        // Product
        orderNow: 'Order Now', soldOut: 'Sold Out', featured: 'Featured',
        inStock: 'In Stock', price: 'Price', selectSize: 'Select Size',
        selectColor: 'Select Color', addToCart: 'Add to Cart', quantity: 'Quantity', close: 'Close',
      ...
      ar: {
        ...
        admin: 'لوحة التحكم', adminLogin: 'دخول المسؤول', login: 'تسجيل الدخول', register: 'إنشاء حساب', logout: 'تسجيل الخروج', account: 'الحساب',
        // Product
        orderNow: 'اطلب الآن', soldOut: 'نفذت الكمية', featured: 'مميز',
        inStock: 'متوفر', price: 'السعر', selectSize: 'اختر المقاس',
        selectColor: 'اختر اللون', addToCart: 'أضف للسلة', quantity: 'الكمية', close: 'إغلاق',
