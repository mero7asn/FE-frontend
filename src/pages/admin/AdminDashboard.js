    ...
    <div className="admin-dashboard">
      <div className="container">
        ...
        <div className="admin-actions">
          ...
          {isSuperAdmin && (
            <Link to="/admin/settings" className="action-card" style={{ borderColor: '#C8A45D' }}>
              <h3>⚙️ Work Model & Payments</h3>
              <p>Switch between WhatsApp and Card Checkout models & configure payment gateways</p>
            </Link>
          )}
        </div>
      </div>
