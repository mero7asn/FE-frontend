...
export const authAPI = {
  ...
  getMyCards: () => api.get('/auth/my-cards'),
...
export const settingAPI = {
  ...
  updateWorkModel: (workModel) => api.put('/settings/work-model', { workModel }),
  updatePaymentSettings: (data) => api.put('/settings/payment-settings', data)
};

export const paymentAPI = {
  initiateCheckout: (data) => api.post('/payments/initiate', data),
  verifyPayment: (orderId, data) => api.post(`/payments/verify/${orderId}`, data)
};
